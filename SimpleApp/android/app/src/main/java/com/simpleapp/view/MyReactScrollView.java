...
public class MyReactScrollView extends ReactScrollView {

    private static final String TAG = "MyReactScrollView";
...
//    private int pullHeight = 100;
    ...
    public MyReactScrollView(ReactContext context) {
        super(context);
        initWithContext(context);
    }

    public MyReactScrollView(ReactContext context, @Nullable FpsListener fpsListener) {
